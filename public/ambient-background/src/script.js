...
var ParticleEngine = (function () {
	...
	function ParticleEngine(canvas_id) {
		console.log(canvas_id, document.getElementById(canvas_id));
		// enforces new
		...
		this.particleSettings = [{ id: "small", num: 10, fromX: 0, toX: this.totalWidth, ballwidth: 3, alphamax: 0.4, areaHeight: .5, color: "#0cdbf3", fill: false },
